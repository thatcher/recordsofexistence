...
@$> /path/to/appengine/bin/dev/dev_appserver.sh /path/to/recordsofexistence/@
...
* "http://localhost:8080/artists?admin":http://localhost:8080/artists?admin
* "http://localhost:8080/artist/roe001?admin":http://localhost:8080/artist/roe001?admin
* "http://localhost:8080/release/roe001?admin":http://localhost:8080/release/roe001?admin
* "http://localhost:8080/release/roe001?admin":http://localhost:8080/release/roe001?admin

or for the impatient

* "http://recordsofexistence.com/artists?admin":http://recordsofexistence.com/artists?admin
* "http://recordsofexistence.com/artist/roe001?admin":http://recordsofexistence.com/artist/roe001?admin
* "http://recordsofexistence.com/release/roe001?admin":http://recordsofexistence.com/release/roe001?admin
* "http://recordsofexistence.com/release/roe001?admin":http://recordsofexistence.com/release/roe001?admin
